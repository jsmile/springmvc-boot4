...
public class CustomerServiceImpl extends AbstractMapService implements ICustomerService
{
   ...
   @Override
   public Customer getById( Integer _id ) { return (Customer) super.getById( _id ); }

   @Override
   public Customer saveOrUpdate( Customer _customer ) { return (Customer) super.saveOrUpdate( _customer ); }
